    ...
    <el-card>
      ...
      <div class="table-box">
        ...
        >
          ...
          <el-table-column prop="trial_run_timedelta" :label="lang_dict.trial_run_timedelta" sortable />
          <el-table-column prop="batch_production_timedelta" :label="lang_dict.batch_production_timedelta" sortable />
    ...
    >
      <el-form ref="$form" :model="model" label-position="left" size="small">
        <el-row :gutter="20" type="flex" justify="start" align="top" tag="div">
          ...
          <el-col :span="6" :offset="0" :push="0" :pull="0" tag="div">
            <el-form-item :rules="rules.trial_run_timedelta" prop="trial_run_timedelta" :label="lang_dict.trial_run_timedelta">
              <el-input-number v-model="model.trial_run_timedelta" :placeholder="$t('Placeholder.Enter')" :style="{width: '100%'}" />
            </el-form-item>
          </el-col>
          <el-col :span="6" :offset="0" :push="0" :pull="0" tag="div">
            <el-form-item :rules="rules.batch_production_timedelta" prop="batch_production_timedelta" :label="lang_dict.batch_production_timedelta">
...
import { GetTableData, AddData, ModifyData, DeleteData, HandleDelete, ExportData, ImportData, GetLangDict } from '@/api/LongConfig/LEDCTData'
