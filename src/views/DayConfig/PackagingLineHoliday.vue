    ...
    <el-card>
      ...
      <div class="table-box">
        ...
        >
          ...
          <el-table-column prop="packaging_line_name" :label="lang_dict.packaging_line_name" sortable />
          <el-table-column prop="holiday_days" :label="lang_dict.holiday_days" />
      ...
      <el-form ref="$form" :model="model" label-position="left" size="small">
        <el-row :gutter="20" type="flex" justify="start" align="top" tag="div">
          <el-col :span="12" :offset="0" :push="0" :pull="0" tag="div">
            <el-form-item :rules="rules.packaging_line_name" prop="packaging_line_name" :label="lang_dict.packaging_line_name">
              <el-input v-model="model.packaging_line_name" :placeholder="$t('Placeholder.Enter')" clearable />
            </el-form-item>
          </el-col>
          <el-col :span="12" :offset="0" :push="0" :pull="0" tag="div">
            <el-form-item :rules="rules.holiday_days" prop="holiday_days" :label="lang_dict.holiday_days">
...
import { GetTableData, AddData, ModifyData, DeleteData, HandleDelete, ExportData, ImportData, GetLangDict } from '@/api/DayConfig/PackagingLineHoliday'
