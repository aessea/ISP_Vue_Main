  ...
  <div id="main-box">
    <el-card>
      <el-row>
        <el-col :span="16">
          <div>
            <el-button v-if="buttons.includes('ProcessAiHoliday/add')" type="primary" @click="addDataDialog">
              <i class="el-icon-plus" />{{ $t('TablePage.BtnAppend') }}
            </el-button>
            <el-button v-if="buttons.includes('ProcessAiHoliday/delete')" type="danger" @click="deleteData">
              <i class="el-icon-delete" />{{ $t('TablePage.BtnDelete') }}
            </el-button>
            <el-button v-if="buttons.includes('ProcessAiHoliday/import')" @click="importDataDialog">
              <i class="el-icon-upload2" />{{ $t('TablePage.BtnImport') }}
            </el-button>
            <el-button v-if="buttons.includes('ProcessAiHoliday/export')" @click="exportDataDialog">
      ...
      <div class="table-box">
        ...
        >
          ...
          <el-table-column prop="post_process_name" :label="lang_dict.post_process_name" sortable />
          ...
          <el-table-column width="110" fixed="right" :label="$t('TablePage.TitleOperate')">
            <template slot-scope="scope">
              ...
              />
              <el-button
                v-if="buttons.includes('ProcessAiHoliday/delete')"
                type="danger"
                size="mini"
                icon="el-icon-delete"
                circle
      ...
      <el-form ref="$form" :model="model" label-position="left" size="small">
        <el-row :gutter="20" type="flex" justify="start" align="top" tag="div">
          <el-col :span="8" :offset="0" :push="0" :pull="0" tag="div">
            <el-form-item :rules="rules.post_process_name" prop="post_process_name" :label="lang_dict.post_process_name">
          ...
          <el-col :span="8" :offset="0" :push="0" :pull="0" tag="div">
            <el-form-item :rules="rules.holiday_begin" prop="holiday_begin" :label="lang_dict.holiday_begin">
              <el-date-picker v-model="model.holiday_begin" type="datetime" :placeholder="$t('Placeholder.Select')" value-format="yyyy-MM-dd HH:mm:ss" :style="{width: '100%'}" />
            </el-form-item>
          </el-col>
          <el-col :span="8" :offset="0" :push="0" :pull="0" tag="div">
            <el-form-item :rules="rules.holiday_end" prop="holiday_end" :label="lang_dict.holiday_end">
              <el-date-picker v-model="model.holiday_end" type="datetime" :placeholder="$t('Placeholder.Select')" value-format="yyyy-MM-dd HH:mm:ss" :style="{width: '100%'}" />
            </el-form-item>
          </el-col>
        </el-row>
      </el-form>
...
import { GetTableData, AddData, ModifyData, DeleteData, HandleDelete, ExportData, ImportData, GetLangDict } from '@/api/DayConfig/ProcessAiHoliday'
  ...
  methods: {
    ...
    handleDelete(index, row) {
      this.$confirm(this.$t('TablePage.MsgDeleteWarn'), this.$t('PublicText.TitleTip'), {
        ...
        const data = {}
        data['id'] = row.id
        data['post_process_name'] = row.post_process_name
        data['user_name'] = this.name
