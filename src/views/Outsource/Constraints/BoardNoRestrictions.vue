  ...
  <div id="main-box">
    <el-card>
      <el-row>
        <el-col :span="16">
          <div>
            <el-button v-if="buttons.includes('BoardNoRestrictions/add')" type="primary" @click="addDataDialog">
              <i class="el-icon-plus" />添加
            </el-button>
            <el-button v-if="buttons.includes('BoardNoRestrictions/delete')" type="danger" @click="deleteData">
              <i class="el-icon-delete" />删除
            </el-button>
            <el-button v-if="buttons.includes('BoardNoRestrictions/import')" @click="importDataDialog">
              <i class="el-icon-upload2" />导入
            </el-button>
            <el-button v-if="buttons.includes('BoardNoRestrictions/export')" @click="exportDataDialog">
        ...
        >
          ...
          <el-table-column width="110" fixed="right" label="操作">
            <template slot-scope="scope">
              <el-button
                v-if="buttons.includes('BoardNoRestrictions/modify')"
                type="primary"
                size="mini"
                icon="el-icon-edit"
                circle
              ...
              />
              <el-button
                v-if="buttons.includes('BoardNoRestrictions/delete')"
                type="danger"
                size="mini"
                icon="el-icon-delete"
                circle
...
import { GetTableData, AddData, ModifyData, DeleteData, HandleDelete, ExportData, ImportData, GetBaseData } from '@/api/Outsource/Constraints/BoardNoRestrictions'
