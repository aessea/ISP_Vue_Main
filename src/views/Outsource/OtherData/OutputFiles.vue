  ...
  <div id="main-box">
    <el-card>
      <el-row>
        <el-col :span="16">
          <div>
            <el-button v-if="buttons.includes('OutputFiles/add')" type="primary" @click="addDataDialog">
              <i class="el-icon-plus" />{{ this.$t('TablePage.BtnAppend') }}
            </el-button>
            <el-button v-if="buttons.includes('OutputFiles/delete')" type="danger" @click="deleteData">
              <i class="el-icon-delete" />{{ this.$t('TablePage.BtnDelete') }}
            </el-button>
            <!-- <el-button v-if="buttons.includes('OutputFiles/import')" @click="importDataDialog">
              <i class="el-icon-upload2" />{{ this.$t('TablePage.BtnImport') }}
            </el-button>
            <el-button v-if="buttons.includes('OutputFiles/export')" @click="exportDataDialog">
        ...
        >
          ...
          <el-table-column width="110" fixed="right" :label="$t('TablePage.TitleOperate')">
            <template slot-scope="scope">
              ...
              />
              <el-button
                v-if="buttons.includes('OutputFiles/delete')"
                type="danger"
                size="mini"
                icon="el-icon-delete"
                circle
