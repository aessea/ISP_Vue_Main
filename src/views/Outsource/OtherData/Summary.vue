  ...
  <div id="main-box">
    <el-card>
      <el-row>
        <el-col :span="16">
          <div>
            <el-button v-if="buttons.includes('Summary/add')" type="primary" @click="addDataDialog">
              <i class="el-icon-plus" />{{ $t('TablePage.BtnAppend') }}
            </el-button>
            <el-button v-if="buttons.includes('Summary/delete')" type="danger" @click="deleteData">
              <i class="el-icon-delete" />{{ $t('TablePage.BtnDelete') }}
            </el-button>
            <!-- <el-button v-if="buttons.includes('Summary/import')" @click="importDataDialog">
              <i class="el-icon-upload2" />{{ $t('TablePage.BtnImport') }}
            </el-button> -->
            <el-button v-if="buttons.includes('Summary/export')" @click="exportDataDialog">
        ...
        >
          ...
          <el-table-column width="110" fixed="right" :label="$t('TablePage.TitleOperate')">
            <template slot-scope="scope">
              ...
              />
              <el-button
                v-if="buttons.includes('Summary/delete')"
                type="danger"
                size="mini"
                icon="el-icon-delete"
                circle
